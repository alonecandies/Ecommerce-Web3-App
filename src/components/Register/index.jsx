...
import { registerWithEmailAndPassword, logout } from "../../server/firebase";
import { signInWithCometChat } from "../../server/cometChat";
...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    if (
      ...
      return;
    registerWithEmailAndPassword(email, password, fullname, phone, account, address).then(
      (user) => {
        if (user) {
          logout().then(() => {
