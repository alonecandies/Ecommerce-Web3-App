...
module.exports = async (callback) => {
  ...
  console.log(
    `Initial balance of storeOwner   | ${web3.utils.fromWei(storeOwnerBal.toString(), "ether")}`,
  );
  ...
  console.log(
    `Balance of seller after sales | ${web3.utils.fromWei(sellerBal.toString(), "ether")}`,
  );
  console.log(
    `Balance of storeOwner after sales | ${web3.utils.fromWei(storeOwnerBal.toString(), "ether")}`,
  );
